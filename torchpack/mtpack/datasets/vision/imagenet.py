...
class ImageNet(Dataset):
    def __init__(self, root, num_classes, image_size, val_ratio=None, extra_train_transforms=None):
        ...
        train = datasets.ImageFolder(root='~/8th_sem/imagenet_dataset/tiny-imagenet-200/train', transform=train_transforms)
        test = datasets.ImageFolder(root='~/8th_sem/imagenet_dataset/tiny-imagenet-200/test', transform=test_transforms)
        ...
        class_indices = dict()
        class_indices = {i: i for i in range(num_classes)}
